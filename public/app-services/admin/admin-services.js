(function() {
    ...
    AdminService.$inject = ['$timeout', '$filter', '$q', '$http', 'config'];
    function AdminService($timeout, $filter, $q, $http, config) {

        var service = {};

        service.GetAll = GetAll;
        service.get_all_employee = get_all_employee;
        ...
        function get_all_employee() {
            return $http({
                method: 'GET',
                url: config.site_url + 'api/admin/get_all_employee'
            });
        }
