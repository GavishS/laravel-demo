                                    ...
                                    <table border='0' cellpadding='50' cellspacing='0' style='margin-left: auto;margin-right: auto;width:600px;text-align:center;' width='600'>
                                        <tr>
                                            <td align='center' valign='top'>
                                                <h1 style="color: #00acec!important;font-size: 50px;">GLOCALS</h1>
                                            </td>
                                        </tr>
                                    </table>
                                </center>
                                                ...
                                                <table border='0' cellpadding='0' cellspacing='0' width='100%'>
                                                    ...
                                                    <tr>
                                                        <td align='center' bgcolor='#00acec' valign='top'>
                                                            <h3><a href="{{$site_url}}#!/verify_registration/{{$register_token}}" style="color: #ffffff !important">Click here to confirm your account</a></h3>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td align='center' valign='top'>
